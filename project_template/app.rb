...
module RetryHandler
  def self.retryable
    ...
    begin
      ...
      if /^You have already activated/ =~ e.message
        STDOUT.puts "I encountered an issue with https://github.com/splaplapla/procon_bypass_man/issues/275, so I'll retry."
        retry_count += 1
